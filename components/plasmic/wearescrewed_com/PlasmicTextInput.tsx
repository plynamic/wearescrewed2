...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: -dFV_3-_4crC/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: Xs2LVWX0cVdy/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__sFjlu)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__vPodb)}
                role={"img"}
              />
            ),
